...
function ForceResetView({ setView, setUsers, users, cpfToReset, showAlert }) {
  ...
  const handleReset = () => { 
    ...
    // NOTA: cpfToReset pode estar nulo se o usuário recarregar a página aqui.
    // Numa app real, isto seria controlado de forma mais segura.
    if (!cpfToReset) {
  ...
  return (
    <VStack spacing={4} w="100%" align="stretch">
      <Text color="white" textAlign="center" lineHeight="1.5" mb="10px">
